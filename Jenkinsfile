node {
    // reference to maven
    // ** NOTE: This 'maven-latest' Maven tool must be configured in the Jenkins Global Configuration.   
	...
	//sh "read imageid"
	   sh "docker tag 499ff35d5902   jayatheertha276/myapplication" //must change the name and tag no
       sh "docker push   jayatheertha276/myapplication"
  }
}
